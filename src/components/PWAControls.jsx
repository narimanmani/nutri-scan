...
export default function PWAControls() {
  ...
  return (
    <div className="rounded-lg border border-emerald-100/70 bg-emerald-50/40 p-4">
      <div className="flex items-start gap-3 text-sm text-emerald-900">
        <div className="mt-1 flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-100 text-emerald-700">
          <Smartphone className="h-4 w-4" />
        </div>
        <div className="flex-1 space-y-3">
          <p className="font-semibold">Install Nutri Scan</p>
          ...
          <div className="grid gap-2">
            ...
            >
              <Trash2 className="mr-2 h-4 w-4" /> Remove cached data
            </Button>
            <Button
              size="sm"
